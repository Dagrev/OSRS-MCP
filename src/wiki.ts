 ...
 *
 * De HTTP-laag, het bouwen van Bucket-query's en het veilig uitlezen van
 * veldwaarden staan in `bucket.ts`; hier staat alleen wat per onderwerp
 * verschilt: welke velden uit welke tabel komen en hoe ze samen een item, een
 * monster of een drop table vormen.
 *
...
export { WikiError, WikiNotFoundError } from "./bucket.js";
